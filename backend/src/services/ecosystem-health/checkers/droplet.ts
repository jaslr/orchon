...
async function checkTcpPort(port: number): Promise<CheckResult> {
...
export async function checkDropletServices(): Promise<EcosystemNode[]> {
  ...
  let dropletStatus: 'healthy' | 'degraded' | 'down' | 'unknown' = 'healthy';
