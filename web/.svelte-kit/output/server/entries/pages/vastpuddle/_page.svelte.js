...
import { N as Network, S as School } from "../../../chunks/school.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let allCampuses = filteredClients.flatMap((client) => client.campuses.map((campus) => ({
      ...campus,
