...
export async function dispatchAlert(projectId, serviceId, alertType, message) {
...
function formatAlertEmail(projectName, alertType, message) {
    return `
...
function formatAlertEmailHtml(projectName, alertType, message) {
